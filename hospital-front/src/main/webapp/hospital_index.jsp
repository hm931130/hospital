        ...
        <div class="item  detail_department clearfix">
            <div class="left">
                ...
                <div class="table">
                    ...
                    <%--					<dl class="clearfix"><dt>外科</dt><dd>--%>
                    <%--					 	<a href="scheduling.html" class="item">心胸外科</a><a href="" class="item">神经外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">普通外科</a><a href="" class="item">耳鼻喉</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">骨科</a><a href="" class="item">乳腺外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">甲状腺外科</a><a href="" class="item">血管外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">烧伤外科</a><a href="" class="item">整形外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">小儿外科</a><a href="" class="item">口腔外科</a>--%>
                    <%--					 </dd>--%>
                    <%--					</dl>--%>
                    <%--					<dl class="clearfix"><dt>诊断相关科室</dt>--%>
                    <%--						<dd>--%>
                    <%--						 	<a href="scheduling.html" class="item">超声医学科</a><a href="" class="item">病理科</a>--%>
                    <%--						 	<a href="scheduling.html" class="item">检验科</a><a href="" class="item">放射科</a>--%>
                    <%--						 	<a href="scheduling.html" class="item">放射治疗科</a><a href="" class="item">药剂科</a>--%>
                    <%--						 	<a href="scheduling.html" class="item">核医学科</a><a href="" class="item">营养科</a>--%>
                    <%--						 	<a href="scheduling.html" class="item">输血科</a><a href="" class="item">病案科</a>--%>
                    <%--						 </dd>--%>
                    <%--					</dl>--%>
                    <%--					<dl class="clearfix"><dt>手术科室</dt><dd>--%>
                    <%--					 	<a href="scheduling.html" class="item">外科学系</a><a href="" class="item">基本外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">骨科</a><a href="" class="item">心外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">整形美容外科</a><a href="" class="item">血管外科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">神经外科</a><a href="" class="item">麻醉科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">妇产科</a><a href="" class="item">眼科</a>--%>
                    <%--					 	<a href="scheduling.html" class="item">耳鼻喉科</a><a href="" class="item">口腔科</a>--%>
                    <%--					 </dd>--%>
                    <%--					</dl>--%>
                </div>
            </div>
